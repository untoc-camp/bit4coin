...
def strategy_2(tasks, task_id: str, symbol = symbols, purchase_percent=purchase_percent, leverage = 1):
...
def strategy_3(tasks, task_id: str, symbol = symbols, purchase_percent=purchase_percent, leverage = 1):
